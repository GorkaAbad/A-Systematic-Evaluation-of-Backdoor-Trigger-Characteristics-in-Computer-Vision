...
def path_name(args):
    ...
    """
    path = f'{args.save_path}/{args.seed}/{args.dataname}_{args.model}_{args.epsilon}_{args.pos}_{args.shape}_{args.trigger_size}_{args.color}_{args.trigger_label}'
    return path
...
def plot_accuracy(list_train_acc, list_test_acc):
    '''
    ...
    plt.plot(list_test_acc, label='test')
    plt.legend()
...
def save_experiments(args, train_acc, train_loss, test_acc_clean, test_loss_clean, test_acc_backdoor,
    ...
    path = '{}/{}/experiments.csv'.format(args.save_path, args.seed)
    header = ['dataname', 'model', 'epsilon', 'pos',
              'shape', 'trigger_size', 'trigger_color', 'trigger_label',
    ...
    with open(path, 'a') as f:
        ...
        writer.writerow([args.dataname, args.model, args.epsilon, args.pos,
                         args.shape, args.trigger_size, args.color, args.trigger_label,
